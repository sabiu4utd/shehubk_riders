...
<head>
    ...
    <title>Ride History - MyRides Driver</title>
    <!-- Bootstrap 5 CSS -->
            ...
            <div class="dashboard-card mb-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-primary-custom w-100" onclick="exportHistory()">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="../../assets/images/default-avatar.png" 
                                     ...
                                     alt="Rider">
                                <div>
                                    <h6 class="mb-1" id="riderName">John Doe</h6>
                                    <div class="text-muted">
                                        <i class="fas fa-phone me-2"></i>
                                        <span id="riderPhone">+234 801 234 5678</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                ...
                                <p class="text-muted">Great service and very polite driver!</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <td>
                        ${ride.rating ? 
                            `<div class="text-warning">
                                ...
                                ride.rating % 1 ? '½' : ''
                                }${'☆'.repeat(5-Math.ceil(ride.rating))}
                            </div>` : 
                            '-'
                        }
                    </td>
